...
Nesta configuração, diversos clientes, sejam computadores, smartphones, etc., se conectam através de uma rede (normalmente, a internet), para acessar os recursos providos por aquele servidor, como representado na \autoref{fig:diagrama-cliente-servidor}.
...
\begin{figure}[H]
    \centering
    \caption[Diagrama representando arquitetura Cliente-Servidor]{Diagrama representando arquitetura Cliente-Servidor}
    \includegraphics[width = 1.0\linewidth]{figs/diagramas/diagrama-cliente-servidor.png}\\
    \fonte{Elaborada pelo autor.}
    \label{fig:diagrama-cliente-servidor}
\end{figure}
...
Um contexto muito popular para este tipo de API é no desenvolvimento de aplicações que devem se comunicar via rede, como na arquitetura Cliente-Servidor, exemplificado na \autoref{fig:diagrama-api}.

\begin{figure}[H]
    \centering
    \caption[Diagrama representando API estilo REST]{Diagrama representando API estilo REST}
    \includegraphics[width = 1.0\linewidth]{figs/diagramas/diagrama-api.png}\\
    \fonte{Elaborada pelo autor.}
    \label{fig:diagrama-api}
\end{figure}
...
A \autoref{fig:diagrama-autenticacao} ilustra esta aplicação, no contexto de um sistema Cliente-Servidor.
...
\begin{figure}[H]
    \centering
    \caption[Diagrama representando uso de JWT para Autenticação]{Diagrama representando uso de JWT para Autenticação}
    \includegraphics[width = 1.0\linewidth]{figs/diagramas/diagrama-autenticacao.png}\\
    \fonte{Elaborada pelo autor.}
    \label{fig:diagrama-autenticacao}
\end{figure}
