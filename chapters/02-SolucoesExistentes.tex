...
\begin{quadro}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline
        \textbf{Características}    & \textbf{Social Bauru} & \textbf{Agenda JC} & \textbf{JaúClick} & \textbf{Qualaboa} & \textbf{Trabalho desenvolvido} \\ \hline
        Publicação direta de evento & Não é possível        & Não é possível     & Não é possível    & Não é possível    & É possível                     \\ \hline
        Apresentação dos dados      & Fraca                 & Fraca              & Ótima             & Regular           & Ótima                          \\ \hline
        Ferramentas de pesquisa     & Fracas                & Fracas             & Fracas            & Regular           & Ótimas                         \\ \hline
        Completude dos dados        & Baixa                 & Baixa              & Regular           & Regular           & Alta                           \\ \hline
        Caráter publicitário        & Sim                   & Sim                & Sim               & Sim               & Não                            \\ \hline
    \end{tabular}
