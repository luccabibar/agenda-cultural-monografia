...
Há também a plataforma Qualaboa \cite{plataforma-qualaboa}, homônima à este projeto.
...
Visto isto, é possível definir os objetivos que o projeto deve cumprir, baseado nas lacunas presentes em plataformas similares. 
Primeiramente, ele deve permitir que qualquer organização publique um evento, ao invés de depender de um redator, pois isso democratiza a divulgação e combate a possibilidade de eventos não serem listados. 
Para garantir a adesão de organizações à plataforma, o processo de publicação de um evento deve ter o mínimo de atrito possível, e isso inclui o uso gratuito do serviço.

Além disso, é importante que as atividades estejam bem organizadas, para que usuários possam facilmente encontrar eventos que os interessem. 
Isso implica em implementar ferramentas para busca e filtragem de conteúdo, além de uma maneira refinada de visualizar tal conteúdo. 
Por último, é importante que os dados referentes a cada atividade também estejam completos e bem dispostos: devem estar disponíveis a data, horário e local de cada atividade, assim como algum contato com o organizador, e também uma imagem ilustrativa.
