...
Ele define um conjunto de regras e pricípios, a fim de tornar as aplicações, e acomunicação entre elas, mais conscisa e organizada.
...
Por fim, uma API Rest tem sempre apenas um estado, ou seja, a aplicação nao armazena nenhum tipo de dado de sessão, e toda requisição teve conter todos os dados necessários para seu processamento.
