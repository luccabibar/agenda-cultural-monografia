...
\begin{figure}[H]
    ...
    \includegraphics[width = 0.7\linewidth]{figs/diagramas/diagrama-classe-evento.png}\\
...
\begin{figure}[H]
    ...
    \includegraphics[width = 0.9\linewidth]{figs/diagramas/diagrama-casouso-usuario-homeless.png}\\
    \fonte{Elaborada pelo autor.}
    \label{fig:use-case-usuario}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width = 0.9\linewidth]{figs/diagramas/diagrama-casouso-orgmod.png}\\
    \fonte{Elaborada pelo autor.}
...
Uma vez definido a estrutura da aplicação, bem como as tecnologias utilizadas em sua implementação, é possível representar a arquitetura do sistema como um todo, como na \autoref{fig:diagrama-arquitetura}.

\begin{figure}[H]
    \centering
    \caption[Diagrama representando a arquitetura do sistema]{Diagrama representando a arquitetura do sistema}
    \includegraphics[width = 0.7\linewidth]{figs/diagramas/diagrama-arquitetura.png}\\
    \fonte{Elaborada pelo autor.}
    \label{fig:diagrama-arquitetura}
\end{figure}

De maneira sucinta, a plataforma se divide nas seguintes telas principais, referentes aos seguintes atores:
