...
Este \autoref{ch.introducao} apresenta a ideia central, e contém a \autoref{sec.detalhamento-problema}, que aprofunda a discussão sobre a problemática apresentada. O \autoref{ch.solucoes-existentes} discorre sobre as opções existentes que já tentam resolver este problema, expondo características que norteiam os objetivos deste trabalho, descritos logo em seguida na \autoref{sec.objetivos}. 
