...
Python é uma linguagem não-tipada, o que torna o desenvolvimento veloz, a princípio.
...
A linguagem Java, por sua vez, é uma linguagem tipada, o que garante a consistência de dados entre os componentes.
...
Entretanto, uma vez que se entende como trabalhar com esta solução, os filtros se tornam uma ferramenta poderosa a ser utilizada no desenvolvimento de qualquer aplicação REST. 
