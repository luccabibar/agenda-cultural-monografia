...
\begin{resumo}
    ...
    Portanto, o limitado tempo disponível para atividades culturais (sejam elas shows, peças, eventos ou festas) deve ser bem investido. 
...
\begin{resumo}[Abstract]
	\begin{otherlanguage*}{english}
        ...
        Therefore, the limited time that is available for cultural activities (such as concerts, plays, or parties) must be well spent. 
