...
\begin{resumo}
	A cultura e o lazer são partes fundamentais da experiência humana, especialmente em sociedade. 
    Portanto, o limitado tempo disponível para atividades culturais (tais como shows, exposições, festas, palestras, entre outros) deve ser bem investido. 
    Entretanto, ao decidir participar de alguma atividade cultural, nem sempre está claro quais são as opções disponíveis numa determinada data ou região, visto que as informações de quais eventos ocorrem estão dispostas de maneira dispersa em meios que nem sequer foram projetados para hospedar este tipo de informação, como em perfis em redes sociais, blogs ou jornais locais. 
    O presente trabalho visa então apresentar uma alternativa: uma plataforma que reúna todas as atividades culturais de uma determinada região, apresentando-as de maneira concisa e organizada, sem que seja necessário demasiado esforço para conferi-las. 
    O mesmo documenta o processo de desenvolvimento desta plataforma, bem como demonstra o resultado satisfatório atingido.\\
	\textbf{Palavras-chave:} Cultura, Lazer, Java, JavaScript, Software.
\end{resumo}
...
\begin{resumo}[Abstract]
	\begin{otherlanguage*}{english}
		Culture and Leisure are fundamental aspects of the human experience, especially in society. 
        Therefore, the limited time that is available for cultural activities (such as concerts, exhibitions, parties, lectures, among others) must be well spent. 
        However, when deciding to partake in a cultural activity, it may not be clear what are the available options in a given date or region, as the information of what events are happening are laid out in media that are not even designed to host this kind of information, such as in social media profiles, blogs, or local newspapers. 
        This essay then aims to present an alternative: a platform that gathers all cultural activities in a given region, presenting them in a concise and organized way, without the need of unnecessary effort to check on them.
        This essay also documents the development process of this platform, and displays the adequate results achieved.\\
		\textbf{Keywords:} Culture, Leisure, Java, JavaScript, Software.
	\end{otherlanguage*}
\end{resumo}
...
\input{chapters/02-SolucoesExistentes}
\input{chapters/03-FundamentacaoTeorica}
\input{chapters/04-EspecificacaoProjeto}
\input{chapters/05-Tecnologias}
% \input{chapters/04-Riscos}
% \input{chapters/05-Cronograma}
\input{chapters/06-Resultados}
\input{chapters/07-Conclusao}
% \input{chapters/07-TrabalhosFuturos}
...
% \nocite{http}
% \nocite{rest}
\nocite{github-cliente}
\nocite{github-servidor}
